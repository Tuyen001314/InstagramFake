...
class FavoriteAdapter() : RecyclerView.Adapter<FavoriteAdapter.ViewHolder?>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.accept.setOnClickListener {
            FirebaseFirestore.getInstance().collection("users/$id/friends").get()
            ...
            FirebaseFirestore.getInstance().collection("users/$id/receive_request").document(firebaseModel.id).delete()
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        val accept: Button = itemView.buttonAccept
        val erase: ImageView = itemView.eraseRequest
    }
